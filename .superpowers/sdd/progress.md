...
PENDIENTE (acciones usuario): rotación de secretos reales (SECURITY_TOKEN/WS_TOKEN, MYSQL_PASSWORD), visibilidad/privacy del repo GitHub, verificación manual en navegador (login admin/inversor, gráficas, control grid_control.json, auditoría).
